...
Freelance Developer and Data Analyst specializing in AI and machine learning solutions. Experienced in leveraging data-driven approaches to solve complex challenges, with a proven track record in research and development, including published work on retrieval-augmented generation.

\section*{SKILLS}
\begin{itemize}[leftmargin=*, label={$\bullet$}]
    \item \textbf{Programming \& Data Analysis:} Python (Pandas, NumPy, Matplotlib), R (R Studio), VBA for Excel, SQL
    \item \textbf{Machine Learning \& AI:} Scikit-learn, PyTorch, TensorFlow, NLP, Retrieval-Augmented Generation, Local AI, GPU Computing
