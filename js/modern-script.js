...
function initScrollAnimations() {
    ...
    const animatedElements = document.querySelectorAll('.skill-category, .project-card, .timeline-item, .about-card');
...
console.log('%c🚀 Paolo Astrino Portfolio Loaded!', 'color: #4f46e5; font-size: 16px; font-weight: bold;');
console.log('%cBuilt with modern web technologies and love for data analytics! 📊', 'color: #10b981; font-size: 12px;');
